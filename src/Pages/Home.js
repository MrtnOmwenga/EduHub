    ...
    return (
        <div className={style.stylePage}>
            <section className={style.Section1}>
                ...
                <div className={style.container}>
                    <div className={style.textcontainer}>
                        <h1 className={style.title}> HUB <br/> EDUCATION </h1>
                    ...
                    <div className={style.ImageSlides}>
                        ...
                        <div className={`${style.slide2} ${style.slides}`}>
                            ...
                            <div className={style.Activities}>
                                ...
                                <p className={style.activitiestext}> Quizzes are specially 
                        ...
                        <div className={`${style.slide3} ${style.slides}`}>
                            ...
                            <div className={style.Activities}>
                                ...
                                <p className={style.activitiestext}>Instructors are available round the clock
            ...
            <section className={style.Section2}>
                <img src={require('./Style/Images/BoardMeeting.png')} className={style.SpanImage} alt=""/>
                <div className={style.textcontainer1}>
                    <h1 className={style.AboutUstitle}> AboutUs </h1>
                    <p className={style.aboutus}>Hub Education is an online platform that provides users with a seamless 
                        learning experience for accessing courses, taking assessments, 
                        and earning certifications. It's user friendly, accessible from anywhere globally, 
                        and offers various courses across various subjects.
                    </p>
                    <button className={style.registerbutton}> <p className={style.buttontext}> Learn More </p></button>
                </div>
            </section>
                ...
                <div className={style.textcontainer4}>
                    ...
                    <div className={style.instructors}>
                        <div className={`${style.instructor1} ${style.instructor}`}>
                            ...
                            <p className={style.instructordetails}>Professor Michaels will be sharing his 
                            work on mobile education platforms for indigent students.</p>
                        </div>
                        <div className={`${style.instructor2} ${style.instructor}`}>
                            <h3 className={style.instructorname}>ELLE PIP, PHD</h3>
                            <p className={style.instructordetails}>A researcher and BSU faculty member since 2010, 
                            Dr. Pip will be joining the summit to speak about new horizons for education.</p>
                        </div>
                        <div className={`${style.instructor3} ${style.instructor}`}>
                            <h3 className={style.instructorname}>GRACE JUDDER, PHD</h3>
                            <p className={style.instructordetails}>Dr. Judder has been working on immersive learning platforms. 
                            He will be sharing his latest findings and best practices.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className={style.Section5}>
                <div className={style.textcontainer5}>
                    <div className={style.contactus}>
                        ...
                        <p className={style.contactinfo}>123 Anywhere St., Any City <br /> State, Country 12345</p>
                    ...
                    <img src={require('./Style/Images/Background.jpg')} className={style.contactimage} alt=""/>
                </div>
            </section>
        </div>
    )
